/** Adapted from @cgaravitoq/pi-claude-code-auth 2.2.2; see lib/claude-auth-LICENSE. */
...
import { registerClaudeHeadersCommand } from "./lib/claude-auth-config.ts";
...
export default function (pi: Pick<ExtensionAPI, "registerProvider" | "registerCommand">) {
  registerClaudeHeadersCommand(pi);
