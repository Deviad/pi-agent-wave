...
- The explicit `/graph watch --follow` view keeps its 1-9 focus keys (FR-7); only the automatic list binds numbers to details. Both READMEs describe the two views separately.
